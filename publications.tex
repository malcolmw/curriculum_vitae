\begin{rSection}{Peer-Reviewed Publications}
	\begin{enumerate}
		\item \textbf{White, M.~C.~A.}, Sharma, K., Li, A., Kumar, T.~K.~S., \& Nakata, N. (In Review) FastMapSVM: Classifying abstract objects using the FastMap algorithm and Support-Vector Machines. \textit{Communications Engineering}
		
		\item \textbf{White, M.~C.~A.}, Zhang Z., Bai T., Qiu H., Chang H. \& Nakata N.
		(In Review) HDF5eis: A Solution for Storage and Access to Big, Multidimensional Data from Environmental Sensors. \textit{GEOPHYSICS}
		
		\item Zhang, Z., \textbf{White, M.~C.~A.}, Bai, T., Qiu, H., \& Nakata, N. (In Review) Characterizing Microseisms Induced by Hydraulic Fracturing with Hybrid Borehole DAS and Three-Component Geophone Data. \textit{GEOPHYSICS}
